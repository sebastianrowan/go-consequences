...
func NASSCropMap() map[string]Crop {
	...
	m["5"] = ReadFromXML(root + "Soybeans.crop")
	m["6"] = ReadFromXML(root + "Sunflower.crop")
	...
	m["21"] = ReadFromXML(root + "Barley.crop")
	m["22"] = ReadFromXML(root + "Durum_Wheat.crop")
	m["23"] = ReadFromXML(root + "Spring_Wheat.crop")
	m["24"] = ReadFromXML(root + "Winter_Wheat.crop")
	//m["25"] = BuildCrop(25, "Other Small Grains")
	//m["26"] = BuildCrop(26, "Dbl Crop WinWht/Soybeans")
	//m["27"] = BuildCrop(27, "Rye")
	m["28"] = ReadFromXML(root + "Oats.crop")
	...
	m["52"] = ReadFromXML(root + "Lentils.crop")
